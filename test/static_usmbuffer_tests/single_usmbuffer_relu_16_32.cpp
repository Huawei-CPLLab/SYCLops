...
int main() {
  ...
  auto IN_acc = (_Array *)malloc_shared(sizeof(_Array), dev, ctx);
...
// clang-format off
// MLIR:      func.func @{{[a-zA-Z0-9\$_]+}}(%arg0: memref<16x32xf32, 1>, %arg1: memref<16x32xf32, 1>) {
// MLIR-NEXT:   %cst = arith.constant 0.000000e+00 : f32
// MLIR-NEXT:   affine.for %arg2 = 0 to 16 {
// MLIR-NEXT:     affine.for %arg3 = 0 to 32 {
// MLIR-NEXT:       %0 = affine.load %arg0[%arg2, %arg3] : memref<16x32xf32, 1>
// MLIR-NEXT:       %1 = arith.cmpf olt, %0, %cst : f32
// MLIR-NEXT:       %2 = arith.select %1, %cst, %0 : f32
// MLIR-NEXT:       affine.store %2, %arg1[%arg2, %arg3] : memref<16x32xf32, 1>
// MLIR-NEXT:     }
// MLIR-NEXT:   }
// MLIR-NEXT:   return
// MLIR-NEXT: }
